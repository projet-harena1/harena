...
@Repository
public class FluxImpossibleRepositoryImpl extends BaseRepository<FluxImpossibleDTO> implements FluxImpossibleRepository {
    ...
    public List<FluxImpossibles> loadAllData() {
        ...
        super.loadAllData(FluxImpossibleDTO.class)
                .forEach(fluxImpossibleDTO -> fluxImpossibles.add(new FluxImpossibles(
