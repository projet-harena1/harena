...
@Repository
public class PatrimoineRepositoryImpl extends BaseRepository<PatrimoineDTO>
    implements PatrimoineRepository {
  ...
  private Patrimoine toPatrimoine(PatrimoineDTO patrimoineDTO) {
    ...
    return new Patrimoine(
        patrimoineDTO.getNom(), possesseur, patrimoineDTO.getT(), new HashSet<>());
  }
