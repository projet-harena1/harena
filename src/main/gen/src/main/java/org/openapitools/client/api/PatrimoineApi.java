...
public class PatrimoineApi {
     ...
     */
    public okhttp3.Call crupdatePatrimoinesCall(GetPatrimoines200Response getPatrimoines200Response, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call crupdatePatrimoinesValidateBeforeCall(GetPatrimoines200Response getPatrimoines200Response, final ApiCallback _callback) throws ApiException {
    ...
    public GetPatrimoines200Response crupdatePatrimoines(GetPatrimoines200Response getPatrimoines200Response) throws ApiException {
        ApiResponse<GetPatrimoines200Response> localVarResp = crupdatePatrimoinesWithHttpInfo(getPatrimoines200Response);
    ...
    public ApiResponse<GetPatrimoines200Response> crupdatePatrimoinesWithHttpInfo(GetPatrimoines200Response getPatrimoines200Response) throws ApiException {
        okhttp3.Call localVarCall = crupdatePatrimoinesValidateBeforeCall(getPatrimoines200Response, null);
     ...
     */
    public okhttp3.Call crupdatePatrimoinesAsync(GetPatrimoines200Response getPatrimoines200Response, final ApiCallback<GetPatrimoines200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = crupdatePatrimoinesValidateBeforeCall(getPatrimoines200Response, _callback);
        Type localVarReturnType = new TypeToken<GetPatrimoines200Response>(){}.getType();
     ...
     */
    public okhttp3.Call getPatrimoineByNomCall(String nomPatrimoine, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPatrimoineByNomValidateBeforeCall(String nomPatrimoine, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'nomPatrimoine' is set
        if (nomPatrimoine == null) {
            throw new ApiException("Missing the required parameter 'nomPatrimoine' when calling getPatrimoineByNom(Async)");
        }
     ...
     */
    public okhttp3.Call getPatrimoineByNomAsync(String nomPatrimoine, final ApiCallback<Patrimoine> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getPatrimoinesCall(Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPatrimoinesValidateBeforeCall(Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
    ...
    public GetPatrimoines200Response getPatrimoines(Integer page, Integer pageSize) throws ApiException {
        ApiResponse<GetPatrimoines200Response> localVarResp = getPatrimoinesWithHttpInfo(page, pageSize);
        return localVarResp.getData();
    }
     ...
     */
    public okhttp3.Call getPatrimoinesAsync(Integer page, Integer pageSize, final ApiCallback<GetPatrimoines200Response> _callback) throws ApiException {
