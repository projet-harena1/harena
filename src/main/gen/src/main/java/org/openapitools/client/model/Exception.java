  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    if (jsonObj == null) {
      if (Exception.openapiRequiredFields.isEmpty()) {
        ...
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in Exception is not found in the empty JSON string",
                Exception.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Entry<String, JsonElement> entry : entries) {
      if (!Exception.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `Exception` properties."
                    + " JSON: %s",
